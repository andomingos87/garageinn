...
description: Maintains and optimizes the infrastructure, deployment pipelines, and environment stability of the GarageInn web application, ensuring code moves from development to production securely, efficiently, and with high visibility into system health.
tools:
  - codebase_search
  - read_file
  - grep
