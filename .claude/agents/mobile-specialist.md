...
description: Ensures the GarageInn application provides a seamless, high-performance experience on mobile devices, optimizing UI/UX for touch interfaces, implementing offline-friendly patterns, and ensuring technical performance on mobile hardware.
tools:
  - codebase_search
  - read_file
  - grep
