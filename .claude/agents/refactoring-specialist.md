...
description: Improves the internal structure of the GarageInn codebase without changing its external behavior, reducing technical debt, improving maintainability, and ensuring adherence to architectural standards around Next.js App Router, Supabase integration, and RBAC patterns.
tools:
  - codebase_search
  - read_file
  - grep
