...
- **Total symbols discovered:** 1317
- **Architecture layers:** Config, Utils, Repositories, Services, Components, Controllers
- **Entry points:** src\lib\units\index.ts, src\lib\supabase\server.ts, src\lib\supabase\index.ts (+23 more)

### Key Components

**Key Interfaces:**
- `UserUnit` — C:\Users\asdom\OneDrive\Documentos\Projetos\garageinn-app\apps\web\src\lib\units\index.ts:9
- `UserRoleInfo` — C:\Users\asdom\OneDrive\Documentos\Projetos\garageinn-app\apps\web\src\lib\supabase\custom-types.ts:15
- `UserUnitInfo` — C:\Users\asdom\OneDrive\Documentos\Projetos\garageinn-app\apps\web\src\lib\supabase\custom-types.ts:24
- `UserWithRoles` — C:\Users\asdom\OneDrive\Documentos\Projetos\garageinn-app\apps\web\src\lib\supabase\custom-types.ts:33
- `AuditLog` — C:\Users\asdom\OneDrive\Documentos\Projetos\garageinn-app\apps\web\src\lib\supabase\custom-types.ts:51
## Agent Lineup
