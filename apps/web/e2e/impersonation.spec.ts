...
test.describe("Impersonação de Usuários", () => {
  test.describe("Visibilidade do botão Personificar", () => {
    test('Admin deve ver o botão "Personificar" para outros usuários ativos', async ({
      page,
    }) => {
      // Login como admin
    ...
    test('Usuário comum não deve ver o botão "Personificar"', async ({
      page,
    }) => {
    ...
    test('Admin não deve ver botão "Personificar" para si mesmo', async ({
      page,
    }) => {
      // Login como admin
      await page.goto("/login");
      ...
      const adminRow = page.locator(
        `table tbody tr:has-text("${ADMIN_EMAIL}")`
      );
  ...
  test.describe("Dialog de confirmação", () => {
    test("Dialog deve mostrar informações do usuário alvo", async ({
      page,
    }) => {
      // Login como admin
      await page.goto("/login");
  ...
  test.describe("Fluxo completo de impersonação", () => {
    test.skip("Impersonação deve redirecionar e mostrar banner", async ({
      page,
    }) => {
  ...
  test.describe("Banner de impersonação", () => {
    test.skip("Banner deve mostrar nome do usuário impersonado", async ({
      page,
    }) => {
    ...
    test.skip('Clicar em "Encerrar" deve restaurar sessão original', async ({
      page,
    }) => {
      // NOTA: Este teste requer estado de impersonação ativo
...
test.describe("Serviço de Impersonação", () => {
  test("Deve retornar erro ao tentar impersonar sem autenticação", async ({
    request,
  }) => {
