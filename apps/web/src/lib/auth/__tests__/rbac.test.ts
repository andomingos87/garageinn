...
describe('getUserPermissions', () => {
  ...
  describe('All database roles should be mapped', () => {
    const rolesToTest = [
      ...
      // Operações
      { role: 'Manobrista', dept: 'Operações', global: false, expectedPerms: ['tickets:read', 'tickets:create'] },
      { role: 'Encarregado', dept: 'Operações', global: false, expectedPerms: ['tickets:read', 'tickets:approve'] },
      { role: 'Supervisor', dept: 'Operações', global: false, expectedPerms: ['tickets:read', 'tickets:approve'] },
      { role: 'Gerente', dept: 'Operações', global: false, expectedPerms: ['tickets:read', 'tickets:triage'] },
      // Compras e Manutenção
      { role: 'Assistente', dept: 'Compras e Manutenção', global: false, expectedPerms: ['tickets:read'] },
      { role: 'Comprador', dept: 'Compras e Manutenção', global: false, expectedPerms: ['tickets:read', 'tickets:execute'] },
      { role: 'Gerente', dept: 'Compras e Manutenção', global: false, expectedPerms: ['tickets:read', 'tickets:triage'] },
      // Financeiro
      { role: 'Auxiliar', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read'] },
      { role: 'Assistente', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read'] },
      { role: 'Analista Júnior', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read', 'tickets:execute'] },
      { role: 'Analista Pleno', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read', 'tickets:approve'] },
      { role: 'Analista Sênior', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read', 'tickets:approve'] },
      { role: 'Supervisor', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read', 'tickets:triage'] },
      { role: 'Gerente', dept: 'Financeiro', global: false, expectedPerms: ['tickets:read', 'tickets:triage'] },
      // TI
      { role: 'Analista', dept: 'TI', global: false, expectedPerms: ['tickets:read', 'tickets:execute'] },
      { role: 'Gerente', dept: 'TI', global: false, expectAdmin: true },
      // RH
      { role: 'Auxiliar', dept: 'RH', global: false, expectedPerms: ['users:read'] },
      { role: 'Assistente', dept: 'RH', global: false, expectedPerms: ['users:read'] },
      { role: 'Analista Júnior', dept: 'RH', global: false, expectedPerms: ['users:read', 'users:create'] },
      { role: 'Analista Pleno', dept: 'RH', global: false, expectedPerms: ['users:read', 'users:update'] },
      { role: 'Analista Sênior', dept: 'RH', global: false, expectedPerms: ['users:read', 'users:update'] },
      { role: 'Supervisor', dept: 'RH', global: false, expectedPerms: ['users:read', 'users:delete'] },
      { role: 'Gerente', dept: 'RH', global: false, expectedPerms: ['users:read', 'users:delete'] },
      // Comercial
      { role: 'Gerente', dept: 'Comercial', global: false, expectedPerms: ['units:read', 'tickets:read'] },
      // Auditoria
      { role: 'Auditor', dept: 'Auditoria', global: false, expectedPerms: ['tickets:read', 'checklists:read'] },
      { role: 'Gerente', dept: 'Auditoria', global: false, expectedPerms: ['tickets:read', 'tickets:approve'] },
      // Sinistros
      { role: 'Supervisor', dept: 'Sinistros', global: false, expectedPerms: ['tickets:read', 'tickets:execute'] },
      { role: 'Gerente', dept: 'Sinistros', global: false, expectedPerms: ['tickets:read', 'tickets:triage'] },
    ]

    rolesToTest.forEach(({ role, dept, global, expectAdmin, expectedPerms }) => {
