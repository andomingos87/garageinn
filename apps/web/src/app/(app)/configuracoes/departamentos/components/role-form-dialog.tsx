          ...
          {showGlobalOption && (
            <div className="flex flex-row items-center justify-between rounded-lg border p-4">
              <div className="space-y-0.5">
                <Label htmlFor="is-global" className="text-base">
                  Cargo Global
                </Label>
                <p className="text-sm text-muted-foreground">
                  Cargos globais não pertencem a um departamento específico e
                  têm permissões especiais (ex: Administrador, Diretor).
                </p>
              </div>
              <Switch
                id="is-global"
