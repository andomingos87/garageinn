    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          ...
          <strong>permanente e irreversível</strong>. Todos os dados
          relacionados (comentários, anexos, histórico, aprovações) serão
          removidos.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Todos os chamados podem ser deletados. Mostrando os últimos 100
            chamados.
          </CardDescription>
        </CardHeader>
        <CardContent>
