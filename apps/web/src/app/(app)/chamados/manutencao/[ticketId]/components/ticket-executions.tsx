          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            {canAddExecution && (
              <p className="text-xs mt-1">
                Clique em &quot;Adicionar&quot; para registrar uma execução
              </p>
            )}
          </div>
        ) : (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <Badge variant="outline" className={config.color}>
                          {EXECUTION_STATUS[
                            execution.status as keyof typeof EXECUTION_STATUS
                          ] || execution.status}
                        </Badge>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                      ...
                      {execution.assigned_user ? (
                        <>
                          <Avatar className="h-6 w-6">
                            <AvatarImage
                              src={
                                execution.assigned_user.avatar_url || undefined
                              }
                            />
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs font-medium truncate">
                              {execution.assigned_user.full_name}
                            </p>
                          </div>
                        </>
                      ) : (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-medium">
                          {formatDate(execution.estimated_end_date)}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-medium">
                          {formatCurrency(execution.estimated_cost)}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        {execution.status === "in_progress" && (
                          <>
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                handleSetWaitingParts(execution.id)
                              }
                              disabled={isPending}
                              className="gap-1"
                            >
                            ...
                            <Button
                              ...
                              variant="default"
                              onClick={() =>
                                handleCompleteExecution(execution.id)
                              }
                              disabled={isPending}
                              className="gap-1"
                            >
