...
import { Car, Building2, Wrench, Users, AlertTriangle } from "lucide-react";

// Categorias de sinistro
export const CLAIM_CATEGORIES: Record<
  string,
  { label: string; icon: typeof Car; className: string }
> = {
  "Veículo de Cliente": {
...
// Tipos de ocorrência
export const OCCURRENCE_TYPES: Record<
  string,
