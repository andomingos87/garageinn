...
export function ClaimMaintenanceLink({
  ...
  const handleCreateMaintenance = () => {
    startTransition(async () => {
      ...
      if (result.error) {
        ...
        toast.success(
          `Chamado de Manutenção #${result.maintenanceTicketNumber} criado com sucesso!`
        );
  ...
  if (linkedTicket) {
    const config = statusConfig[linkedTicket.status] || {
      label: linkedTicket.status,
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <Button
              ...
              onClick={() =>
                router.push(`/chamados/manutencao/${linkedTicket.id}`)
              }
            >
        ...
        <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Será criado um novo chamado de manutenção vinculado a este
                sinistro. Os dados do sinistro serão copiados automaticamente
                para o novo chamado.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
