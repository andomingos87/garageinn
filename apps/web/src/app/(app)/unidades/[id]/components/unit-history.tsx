                  ...
                  {entry.changes.length > 0 && (
                    <div className="mt-2 space-y-1.5">
                      {entry.changes.map((change, idx) => (
                        <div
                          key={idx}
                          className="text-xs flex items-start gap-1.5 text-muted-foreground bg-muted/50 rounded px-2 py-1"
                        >
                          ...
                          {change.old_value && (
                            <>
                              <span
                                className="line-through truncate max-w-[120px]"
                          ...
                          <span
                            ...
                            title={change.new_value || undefined}
                          >
