...
interface UnitFormProps {
  ...
  onSubmit: (
    data: UnitFormData
  ) => Promise<{ success?: boolean; error?: string; unitId?: string }>;
}
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleChange("status", value as UnitStatus)
                  }
                  disabled={isPending}
                >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Dados complementares da unidade</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
