...
description: Ensures the codebase remains maintainable and understandable by bridging the gap between complex code implementations and human-readable guides, focusing on both developer experience (DX) and system clarity.
tools:
  - codebase_search
  - read_file
  - list_dir
