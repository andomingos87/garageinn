...
description: Designs, implements, and maintains high-quality, accessible, and performant user interfaces for the GarageInn web application, ensuring consistent UI patterns across dashboards, ticket management systems, and configuration modules.
tools:
  - codebase_search
  - read_file
  - grep
