...
description: Responsible for end-to-end implementation of new functionalities within the GarageInn repository, translating business requirements into production-ready code, ensuring UI consistency, robust business logic, and secure data access via Supabase.
tools:
  - codebase_search
  - read_file
  - grep
