...
description: Maintains and evolves the server-side infrastructure of the GarageInn application, ensuring robust data persistence, secure authentication, and efficient business logic orchestration via Supabase and Next.js Server Actions.
tools:
  - codebase_search
  - read_file
  - grep
