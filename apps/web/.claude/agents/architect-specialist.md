...
description: Maintains the structural integrity, scalability, and security of the GarageInn Web application, ensuring new features align with Next.js App Router patterns, Supabase integration strategies, and the RBAC security model.
tools:
  - codebase_search
  - read_file
  - list_dir
